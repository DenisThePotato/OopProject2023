 ...
 * a class representing a division expression.
 */
public class Div extends BinaryExpression implements Expression {
    ...
    public Expression assign(String var, Expression expression) {
        return new Div(getFirstExpression().assign(var, expression), getSecondExpression().assign(var, expression));
    }
    ...
    public Expression differentiate(String variable) {
        return new Div(
                (new Minus(
                        new Mult(getFirstExpression().differentiate(variable), getSecondExpression()),
                        new Mult(getFirstExpression(), getSecondExpression().differentiate(variable)))),
                new Pow(getSecondExpression(),
                        new Num(2)));
    }
    ...
    public Expression simplify() {
        ...
        try {
            return new Num(new Div(simplifiedFirstExpression, simplifiedSecondExpression).evaluate());
        } catch (Exception e) {
        }
        return new Div(simplifiedFirstExpression, simplifiedSecondExpression);
        }
}
