...
public class Paddle implements Collidable, Sprite {
    ...
    public void timePassed() {
        ...
        if (keyboard.isPressed(KeyboardSensor.LEFT_KEY)) {
            if (this.paddle.getUpperLeft().getX() - paddleSpeed >= cornerBlocksWidth) {
                this.paddle.getUpperLeft().setX(this.paddle.getUpperLeft().getX() - paddleSpeed);
            } else {
                this.paddle.getUpperLeft().setX(cornerBlocksWidth);
            }
        } else if (keyboard.isPressed(KeyboardSensor.RIGHT_KEY)) {
            if (this.paddle.getUpperLeft().getX() + this.paddle.getWidth() + paddleSpeed
                    <= guiWidth - cornerBlocksWidth) {
                this.paddle.getUpperLeft().setX(this.paddle.getUpperLeft().getX() + paddleSpeed);
            } else {
